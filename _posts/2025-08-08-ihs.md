...
- *Query optimization*: similarly, if a query optimizer knows that some column is defined by another, it can leverage such information to short-circuit some table joins or even avoid table lookups altogether {% cite 10.1145/146931.146932 %}.
